  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1>Software de gestão de tarefas, equipes e processos totalmente personalizado para a sua empresa</h1>
        <p class="lead">Gerencie e automatize os processos da sua empresa no Abas Online e não desperdice tempo da sua equipe com tarefas repetitivas.</p>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-md-4">
        <a href="segmento/departamento-pessoal" title="Gestão de departamento pessoal" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/recursos-humanos" title="Gestão de recursos humanos" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="fluxo-de-trabalho/gestao-de-compras" title="Gestão de compras e estoque" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/manutencao" title="Gestão de manutenções" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/juridico" title="Gestão de setor jurídico" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/tecnologia-da-informacao" title="Gestão de demandas de TI" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/marketing-e-comercial" title="Gestão de Marketing" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/marketing-e-comercial" title="Gestão de departamento comercial" class="segmentos__card">
          <div class="card-head">
      ...
      <div class="col-12 col-md-4">
        <a href="segmento/financeiro" title="Gestão de departamento financeiro" class="segmentos__card">
          <div class="card-head">
...
<?php
require_once("template_parts/depoimentos-carrossel.php");
