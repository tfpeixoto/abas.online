...
function abas_scripts()
{
  ...
  wp_enqueue_script('scroll', 'https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.js', array('jquery'), '3.1.5', true);
