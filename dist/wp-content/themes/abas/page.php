  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        ...
        <a type="button" href="#" class="btn btn-amarelo contactBtn" data-toggle="modal" data-target="#modalConversao">Fale com um consultor <i class="fas fa-chevron-right"></i></a>
      </div>
    </div>
  </div>
</section>
